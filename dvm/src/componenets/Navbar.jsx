...
function Navbar() {
    ...
    return (
        <div className={`Nav fixed top-0 left-0 h-[30px] w-full z-10 align-middle  max-lg:opacity-85 z-5 ${windowWidth > 1024 ? `${visible ? 'translate-y-0 duration-1000' : '-translate-y-[100vh] duration-500'}` : ''} `}>
