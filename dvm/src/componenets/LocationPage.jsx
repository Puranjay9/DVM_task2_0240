    ...
    <div className="bg-inherit text-black mt-[170px] ">
      <div className="container mx-auto ml-[100px] max-sm:ml-2 relative">
        <div className=''>
            ...
            <div className="absolute top-1 left-[11.25rem] max-sm:left-2  w-7/12 h-full border-t border-r border-solid border-[#00112e] rounded-tr-[6rem] z-[1] box-border visible max-sm:hidden" ></div>
        </div>
